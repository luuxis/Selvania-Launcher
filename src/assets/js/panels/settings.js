...
class Settings {
    ...
    async initJavaPath() {
        ...
        let javaPath = javaDatabase ? javaDatabase : 'Utiliser la version de java livrée avec le launcher';
        ...
        document.querySelector(".path-button-reset").addEventListener("click", () => {
            path.value = 'Utiliser la version de java livrée avec le launcher';
            file.value = '';
