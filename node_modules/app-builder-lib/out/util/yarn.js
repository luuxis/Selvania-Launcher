...
async function nodeGypRebuild(frameworkInfo, arch) {
...
/** @internal */
async function rebuild(appDir, buildFromSource, frameworkInfo, arch) {
    builder_util_1.log.info({ arch: builder_util_1.Arch[arch], version: frameworkInfo.version, appDir }, "executing @electron/rebuild");
